 ...
 *         &lt;element ref="{urn://bancodebogota.com/ifx/base/v1/}Cut" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class SvcRqType {
    ...
    /**
     * 
     * 						Identificador único del mensaje que entrega la
     * 						aplicación.
     * 							
     * 
     * @return
    ...
    /**
     * 
     * 						Identificador de solicitud asincrónica, enviado
     * 						por un cliente para obtener una respuesta
     * 						asíncrona generada por un servidor, por lo
     * 						general, en el caso de que la respuesta ha
     * 						tomado demasiado tiempo para construir y ser
     * 						capaz de ser enviados de manera sincrónica.
     * 							
     * 
     * @return
     *     possible object is
    ...
    /**
     * 
     * 						Secuencia de transación del cliente para
     * 						reversos.
     * 							
     * 
     * @return
    ...
    /**
     * 
     * 						En este campo se parametriza la información del
     * 						usuario que autentica el servicio.
     * 							
     * 
     * @return
     *     possible object is
    ...
    /**
     * 
     * 						El proveedor del pago indica que éste debe
     * 						realizarse normalmente para el próximo día.
     * 							
     * 
     * @return
     *     possible object is
     ...
     * 
     * 						En este campo se parametriza la información del
     * 						ambiente que origina la invocación.
     * 							
     * 
     * @return
     *     possible object is
    ...
    /**
     * 
     * 						Identificador de secuencia generado por la
     * 						terminal del cliente en un ambiente de
     * 						oficina/CallCenter/cajero.
     * 							
     * 
     * @return
     *     possible object is
     ...
     * 						la transacción en la Red sobre el procesamiento
     * 						de la red, es decir, propietario, ubicación,
     * 						código de banco y el número de referencia
     * 						asignado por la red durante el procesamiento de
     * 						la transacción.
     * 							
     * 
     * @return
    ...
    /**
     * 
     * 						Tiempo de acuerdo con el cliente, se puede
     * 						comparar con el tiempo del servidor para
     * 						determinar si hay una discrepancia.
     * 							
     * 
     * @return
     *     possible object is
