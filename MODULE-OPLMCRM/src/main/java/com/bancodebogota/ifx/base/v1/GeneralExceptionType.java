...
/**
 * <p>Clase Java para GeneralException_Type complex type.
 * 
 * <p>El siguiente fragmento de esquema especifica el contenido que se espera que haya en esta clase.
 * 
 * <pre>
 * &lt;complexType name="GeneralException_Type"&gt;
 *   &lt;complexContent&gt;
...
@XmlType(name = "GeneralException_Type", propOrder = {
    "rqUID",
    "status"
})
public class GeneralExceptionType {
    ...
    /**
     * 
     * 						En este campo se parametriza el identificador único del mensaje que entrega la aplicación 
     * 							
     * 
     * @return
     *     possible object is
