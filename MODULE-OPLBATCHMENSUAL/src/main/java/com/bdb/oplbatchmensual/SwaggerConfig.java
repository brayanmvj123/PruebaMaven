package com.bdb.oplbatchmensual;
...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bdb.oplbatchmensual.controller.service.control"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("MODULE-OPLBATCHMENSUAL",
