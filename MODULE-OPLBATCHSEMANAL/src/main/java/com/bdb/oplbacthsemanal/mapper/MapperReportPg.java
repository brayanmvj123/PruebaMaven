package com.bdb.oplbacthsemanal.mapper;
...
public interface MapperReportPg {
    ...
    SalPgSemanalDownEntity toColumnsReportPgWeekly(ColumnsReportPgWeekly columnsReportPgWeekly);
    ...
    AjusLiqDiaEntity toSalpgtoAjusLiqDia(SalPgDownEntity columnsReportPgWeekly);
    ...
    @Mapping(source = "ctaInv", target = "oplPgTblCtaInv")
    @Mapping(source = "numTit", target = "oplPgTblNumTit")
    AjusLiqSemEntity toSalpgtoAjusLiqSem(SalPgSemanalDownEntity columnsReportPgWeekly);

    List<AjusLiqSemEntity> listToSalpgtoAjusLiqSem(List<SalPgSemanalDownEntity> columnsReportPgWeekly);

    @Mapping(source = "tipBase", target = "base")
    @Mapping(target = "tipoPlazo", expression = "java(java.lang.Integer.parseInt(salPgSemanal.getTipPlazo()))")
    @Mapping(target = "fechaVencimiento", expression = "java( salPgSemanal.getFechaVen().format(java.time.format.DateTimeFormatter.ofPattern(\"yyyy/MM/dd\")))")
    @Mapping(target = "fechaProxPago", expression = "java(java.time.LocalDate.parse(salPgSemanal.getFechaProxPg(), java.time.format.DateTimeFormatter.ofPattern(\"yyyy-MM-dd\")).format(java.time.format.DateTimeFormatter.ofPattern(\"yyyy/MM/dd\")))")
    @Mapping(source = "tipPeriodicidad", target = "periodicidad")
    ParametersFechaInicioPeriodo salPgSemanalToParamsFechaInicioPeriodo(SalPgSemanalDownEntity salPgSemanal);
    ...
    ParametersTasaVariable salPgSemanalToParamsTasaVariable(String tipoTasa, LocalDate fechaEmi);


    @Mapping(source = "salPgSemanal.tipBase", target = "base")
    @Mapping(source = "salPgSemanal.capPg", target = "capital")
    @Mapping(source = "salPgSemanal.tipPlazo", target = "tipoPlazo")
    @Mapping(source = "diasPlazo", target = "diasPlazo")
    @Mapping(source = "salPgSemanal.tipPeriodicidad", target = "periodicidad")
    @Mapping(source = "retencion", target = "retencion")
    @Mapping(source = "tasa", target = "tasa")
    @Mapping(source = "salPgSemanal.tipTasa", target = "tipoTasa")
    @Mapping(source = "salPgSemanal.spread", target = "spread")
    ParametersSimuladorCuota salPgSemanalToParametersSimuladorCuota(SalPgSemanalDownEntity salPgSemanal, String tasa, String diasPlazo, String retencion);
    ...
    JSONRequestCalculadoraDias salPgSemanalToJSONRequestCalculadoraDias(Integer base, LocalDate fechaEmi, LocalDate fechaVen);
    ...
    List<JSONGetSalPgSemanal> listColumnsReportPgWeeklytoJSONGetSalPgSemanal(List<ColumnsReportPgWeekly> columnsReportPgWeekly);
}
