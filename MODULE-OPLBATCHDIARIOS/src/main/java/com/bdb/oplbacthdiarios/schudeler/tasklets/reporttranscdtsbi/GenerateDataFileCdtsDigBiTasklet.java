...
public class GenerateDataFileCdtsDigBiTasklet implements Tasklet, StepExecutionListener {

    private final OperationBatchTransCdtsDigBi operationBatchTransCdtsDigBi;

    public GenerateDataFileCdtsDigBiTasklet(OperationBatchTransCdtsDigBi operationBatchTransCdtsDigBi){
    ...
    public RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        operationBatchTransCdtsDigBi.getData();
