package com.bdb.opaloshare.persistence.model.jsonschema.semanal;
...
@AllArgsConstructor
@NoArgsConstructor
public class JSONGetSalPgSemanal {
    ...
    @Schema(description = "Descripción: Indica el estado de envío de un CDT, 1=Enviado, 2= No enviado", name = "enviado",
