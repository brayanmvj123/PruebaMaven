...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.bdb.opalo.cofnal.controller.service.control"))
    ...
    private ApiInfo apiInfo() {
        return new ApiInfo("MODULE-OPLCOFNAL",
                "Este modulo realiza tareas de carga, procesamiento y almacenamiento de datos.",
                version,
                "Terms of service",
